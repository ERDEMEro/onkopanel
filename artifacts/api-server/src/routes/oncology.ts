...
const CANCER_KEYWORDS: Record<string, string[]> = {
  "Meme": ["meme karsinomu", "meme kanseri", "meme malign", "meme ca", "meme tümörü", "mastektomi", "lumpektomi"],
  "Akciğer": ["akciğer karsinomu", "akciğer kanseri", "nsclc", "sclc", "akciger", "akciğer tümörü", "bronş karsinomu", "plevral efüzyon malign"],
  "Kolorektal": ["kolorektal", "kolon kanseri", "rektum kanseri", "colorektal", "kolon karsinomu", "rektum karsinomu", "sigmoid kolon"],
  "Lenfoma": ["lenfoma", "hodgkin", "diffuse large", "non-hodgkin", "b hücreli lenfoma", "t hücreli lenfoma", "dlbcl"],
  "Prostat": ["prostat kanseri", "prostat karsinomu", "prostat adenokarsinomu", "prostatektomi"],
  "Over": ["over kanseri", "over karsinomu", "over malign", "yumurtalık kanseri"],
  "Mide": ["mide kanseri", "gastrik karsinom", "gastric", "mide karsinomu", "mide tümörü", "gastrektomi"],
  "Pankreas": ["pankreas kanseri", "pankreatik", "pankreas karsinomu", "pankreas tümörü"],
  "Tiroid": ["tiroid kanseri", "tiroid karsinomu", "tiroidektomi", "papiller tiroid", "folliküler tiroid"],
  "Böbrek": ["böbrek kanseri", "böbrek karsinomu", "renal hücreli karsinom", "nefrektomi"],
  "Mesane": ["mesane kanseri", "mesane karsinomu", "mesane tümörü", "sistektomi"],
  "Karaciğer": ["hepatosellüler karsinom", "karaciğer kanseri", "karaciğer karsinomu", "hcc", "kolanjiyokarsinom"],
  "Serviks/Endometrium": ["serviks kanseri", "endometrium kanseri", "endometriyum kanseri", "uterus malign", "histerektomi malign"],
  "Beyin": ["beyin tümörü", "glioblastom", "gliom", "astrositom", "beyin malign"],
  "Multipl Miyelom": ["multipl miyelom", "miyelom", "plazmosit", "plazma hücreli"],
  "Lösemi": ["lösemi", "akut lenfoblastik", "akut miyeloid", "aml", "all", "cml", "cll"],
  "Deri": ["melanom", "malign melanom", "bazal hücreli karsinom", "skuamöz hücreli deri"],
  "Sarkom": ["sarkom", "osteosarkom", "rabdomiyosarkom", "kondrosarkom", "leiomiyosarkom"],
};
...
const LIBRARY_CANCER_DETECT: Array<{ key: string; labelTr: string; labelEn: string; keywords: string[] }> = [
  { key: "thyroid",    labelTr: "Tiroid Kanseri",                labelEn: "Thyroid Cancer",        keywords: ["tiroid karsinomu", "tiroid kanseri", "tiroid malign", "tiroid ca", "tiroid tm", "tiroidektomi", "total tiroid", "papiller tiroid", "tiroid papiller", "folliküler tiroid", "papiller karsinom", "folliküler karsinom", "hemitroidektomi", "tiroid adenokarsinomu", "tru-cut tiroid", "medüller tiroid", "anaplastik tiroid"] },
  { key: "ovarian",    labelTr: "Over Kanseri",                  labelEn: "Ovarian Cancer",        keywords: ["over karsinomu", "over kanseri", "over ca", "over malign", "yumurtalık kanseri", "yumurtalık karsinomu", "ovarium karsinomu", "over tümörü", "over malign neoplazmı", "over seröz karsinom", "over endometrioid", "over müsinöz karsinom", "tuba uterina malign"] },
  { key: "brain",      labelTr: "Beyin Tümörü",                  labelEn: "Brain Tumor",           keywords: ["beyin malign", "glioblastom", "gliom", "beyin tümörü", "serebral tümör", "intrakranial tümör", "astrositom", "kranial tümör", "meningiom", "oligodendrogliom", "ependimom", "beyin metastazı", "kraniyofarenjiom", "santral sinir sistemi tümörü", "glioblastoma multiforme"] },
  { key: "kidney",     labelTr: "Böbrek Kanseri",                labelEn: "Kidney Cancer",         keywords: ["böbrek karsinomu", "böbrek kanseri", "renal hücreli karsinom", "böbrek ca", "böbrek malign", "böbrek tm", "renal cell", "böbrek tümörü", "böbrek malign neoplazmı", "nefrektomi", "böbrek adenokarsinomu", "clear cell renal", "böbrek pelvis karsinomu", "renal karsinom"] },
  { key: "breast",     labelTr: "Meme Kanseri",                  labelEn: "Breast Cancer",         keywords: ["meme karsinomu", "meme kanseri", "meme malign neoplazmı", "meme malign", "meme ca", "meme tümörü", "meme duktal karsinom", "meme lobüler karsinom", "mastektomi", "lumpektomi", "meme invaziv karsinom", "meme in situ", "triple negatif meme"] },
  { key: "prostate",   labelTr: "Prostat Kanseri",               labelEn: "Prostate Cancer",       keywords: ["prostat karsinomu", "prostat kanseri", "prostat adenokarsinomu", "prostat ca", "prostat malign neoplazmı", "prostat malign", "prostatektomi", "prostat tm", "prostat tümörü", "radikal prostatektomi", "prostat gleason", "psa yüksekliği malign"] },
  { key: "bladder",    labelTr: "Mesane Kanseri",                labelEn: "Bladder Cancer",        keywords: ["mesane karsinomu", "mesane kanseri", "mesane malign neoplazmı", "mesane tümörü", "mesane tm", "mesane malign", "transuretral rezeksiyon", "tür mesane", "mesane ürotelyal", "mesane papiller", "sistektomi"] },
  { key: "lung",       labelTr: "Akciğer Kanseri",               labelEn: "Lung Cancer",           keywords: ["akciğer karsinomu", "akciğer kanseri", "akciğer malign neoplazmı", "akciğer ca", "küçük hücreli akciğer", "nsclc", "sclc", "akciğer tümörü", "akciğer malign", "pulmoner malign neoplazmı", "plevral efüzyon malign", "trakea tümörü", "akciğer adenokarsinomu", "akciğer skuamöz hücreli", "bronş karsinomu", "bronş malign", "akciğer lobektomi"] },
  { key: "liver",      labelTr: "Karaciğer Kanseri",             labelEn: "Liver Cancer",          keywords: ["hepatosellüler karsinom", "hepatoselüler karsinom", "karaciğer karsinomu", "karaciğer kanseri", "karaciğer ca", "karaciğer malign neoplazmı", "safra yolu kanseri", "kolanjiyokarsinom", "intrahepatik safra yolları malign", "karaciğer ve intrahepatik safra", "karaciğer malign", "hepatik malign neoplazmı", "karaciğer hücreli karsinom", "hcc", "safra kesesi karsinomu", "safra kesesi kanseri"] },
  { key: "colorectal", labelTr: "Kolon/Rektum Kanseri",          labelEn: "Colorectal Cancer",     keywords: ["kolorektal", "kolon karsinomu", "kolon kanseri", "rektum karsinomu", "rektum kanseri", "rektal karsinom", "kolon ca", "kolon tümörü", "rektum tümörü", "kolon malign neoplazmı", "sigmoid kolon", "çekum karsinomu", "kolektomi", "hemikolektomi", "anterior rezeksiyon", "kolorektal adenokarsinom"] },
  { key: "pancreatic", labelTr: "Pankreas Kanseri",              labelEn: "Pancreatic Cancer",     keywords: ["pankreas karsinomu", "pankreas kanseri", "pankreas ca", "pankreas tümörü", "pankreas malign", "pankreas malign neoplazmı", "pankreas adenokarsinomu", "pankreas başı kanseri", "whipple prosedürü", "pankreatektomi", "pankreatik karsinom"] },
  { key: "cervical",   labelTr: "Serviks/Endometriyum Kanseri",  labelEn: "Cervical/Endometrial",  keywords: ["serviks karsinomu", "serviks kanseri", "endometrium karsinomu", "endometrium kanseri", "endometriyum kanseri", "rahim kanseri", "endometrium malign", "endometriyum malign", "korpus uteri malign", "uterus malign", "serviks malign", "rahim tümörü", "uterus kanseri", "serviks skuamöz hücreli", "serviks adenokarsinomu", "histerektomi malign", "endometrium adenokarsinomu"] },
  { key: "lymphoma",   labelTr: "Lenfoma",                       labelEn: "Lymphoma",              keywords: ["lenfoma", "hodgkin", "diffuse large", "non-hodgkin", "lenf bezi kanseri", "lenf bezi malign", "b hücreli lenfoma", "t hücreli lenfoma", "dlbcl", "folliküler lenfoma", "mantle cell lenfoma", "burkitt", "mediastinal lenfoma"] },
  { key: "leukemia",   labelTr: "Lösemi",                        labelEn: "Leukemia",              keywords: ["lösemi", "akut lenfoblastik", "akut miyeloid", "kronik miyeloid", "kronik lenfositik", "aml", "all", "cml", "cll", "lösemi tanısı", "kan kanseri", "kemik iliği kanseri", "lenfoblastik lösemi", "miyeloid lösemi", "akut lösemi", "kronik lösemi"] },
  { key: "stomach",    labelTr: "Mide Kanseri",                  labelEn: "Stomach Cancer",        keywords: ["mide karsinomu", "mide kanseri", "gastrik karsinom", "mide tümörü", "gastrik kanser", "mide malign", "mide malign neoplazmı", "mide adenokarsinomu", "gastrektomi", "mide skuamöz", "gastroözofageal kavşak", "gist", "gastrointestinal stromal tümör"] },
  { key: "myeloma",    labelTr: "Multipl Miyelom",               labelEn: "Multiple Myeloma",      keywords: ["multipl miyelom", "miyelom", "plazmosit", "plazma hücreli", "kemik iliği miyelom", "ig miyelom", "kappa hafif zincir", "lambda hafif zincir"] },
  { key: "skin",       labelTr: "Deri Kanseri",                  labelEn: "Skin Cancer",           keywords: ["melanom", "malign melanom", "bazal hücreli karsinom", "bazal hücreli kanser", "skuamöz hücreli deri", "deri kanseri", "deri karsinomu", "deri malign", "melanoma", "kutanöz melanom", "deri tümörü", "aktinik keratoz malign", "merkel hücreli"] },
  { key: "sarcoma",    labelTr: "Sarkom",                        labelEn: "Sarcoma",               keywords: ["sarkom", "osteosarkom", "rabdomiyosarkom", "kondrosarkom", "leiomiyosarkom", "liposarkom", "ewing sarkom", "yumuşak doku sarkomu", "kemik sarkomu", "fibrosarkom", "anjiyosarkom", "sarkom tümörü"] },
